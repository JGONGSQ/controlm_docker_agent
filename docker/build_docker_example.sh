...
sudo docker build --build-arg AAPI_END_POINT=https://192.168.1.177:8443/automation-api --build-arg AAPI_USER=workbench --build-arg AAPI_PASS=workbench --build-arg AGENT_IMAGE_NAME=Agent.Linux  . 
